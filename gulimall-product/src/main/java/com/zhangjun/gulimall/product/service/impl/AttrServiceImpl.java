...
import com.zhangjun.gulimall.product.dao.AttrAttrgroupRelationDao;
import com.zhangjun.gulimall.product.dao.AttrGroupDao;
...
import com.zhangjun.gulimall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public AttrRespVo getAttrInfo(Long attrId) {
        ...
        if(attrEntity.getAttrType() == ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode()){
            //1 设置分组信息
            AttrAttrgroupRelationEntity attrgroup = relationDao.selectOne(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id", attrId));
            if(attrgroup != null){
                respVo.setAttrGroupId(attrgroup.getAttrGroupId());
